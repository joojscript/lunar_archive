defmodule Lunar.Registry.SessionManager do
  ...
  def retrieve_session_from_session_id(session_id) do
    GenServer.call(__MODULE__, {:retrieve_session_from_session_id, session_id})
  end

  def handle_call({:create_session, user}, _from, _state) do
    session_id = Ecto.UUID.generate()
    :ets.insert(@global_session_bucket_key, {session_id, user})
    {:reply, {:ok, session_id}, session_id}
  end

  def handle_call({:retrieve_session_from_session_id, session_id}, _from, state) do
